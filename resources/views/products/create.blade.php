...
{{--        <input type="hidden" name="count_images" value="1" />--}}
        ...
        <button onclick="alert('Produsul a fost creat!')" type="submit" class="btn btn-primary button-create">Crează Produsul</button>
    </form>
